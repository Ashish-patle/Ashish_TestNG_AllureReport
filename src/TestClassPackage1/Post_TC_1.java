...
public class Post_TC_1
{
	...
	for (int i=0; i<5 ; i++)
	{
		int statusCode = API_Common_Function1.statusCode(post_req_repository.baseURI(),post_req_repository.resource(),post_req_repository.post_req_TC_1());
		if(statusCode==201)
		{
			String responseBody = API_Common_Function1.responseBody(post_req_repository.baseURI(),post_req_repository.resource(),post_req_repository.post_req_TC_1());
		Post_TC_1.validator(responseBody,statusCode);
		Utility_CommonFunctions1.evidencefilescreator("Ashish",post_req_repository.post_req_TC_1() , responseBody);
